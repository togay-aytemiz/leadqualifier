...
export default async function RegisterCheckEmailPage({ searchParams }: RegisterCheckEmailPageProps) {
    ...
    return (
        <div>
            <div className="mb-7">
                ...
                <h1 className="text-3xl font-semibold tracking-tight text-gray-900">{t('registerCheckEmailTitle')}</h1>
