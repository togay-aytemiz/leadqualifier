...
import { getKnowledgeBaseEntry, updateKnowledgeBaseEntry, getCollections, KnowledgeCollection, KnowledgeBaseEntry } from '@/lib/knowledge-base/actions'
...
export default function EditContentPage() {
    ...
    useEffect(() => {
        Promise.all([
            ...
            setCollectionId(entry.collection_id || '')
            setLoading(false)
        }).catch(err => {
            console.error(err)
