...
export default async function QaLabRunDetailPage({ params }: QaLabRunDetailPageProps) {
    ...
    const qaLabListHref = '/admin/qa-lab'
        ...
        return (
            <div className="flex-1 bg-white flex flex-col min-w-0 overflow-hidden">
                <PageHeader
                    ...
                    breadcrumb={(
                        <Link href={qaLabListHref} className="text-gray-400 hover:text-gray-600 flex items-center gap-1 text-sm mr-2 transition-colors">
                            <ArrowLeft size={18} />
                            {tCommon('back')}
                        </Link>
                    )}
