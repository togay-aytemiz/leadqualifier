...
describe('applyBotMessageDisclaimer', () => {
    ...
    it('uses Turkish disclaimer when the outgoing message is clearly Turkish even if the language hint is English', () => {
        const result = applyBotMessageDisclaimer({
            message: 'Bu konu hakkında daha fazla bilgi veremem. Ancak yardımcı olabileceğim başka bir konu varsa yazabilirsiniz.',
            responseLanguage: 'en',
            settings: {
                bot_disclaimer_enabled: true,
                bot_disclaimer_message_tr: 'Bu mesaj AI bot tarafından oluşturuldu, hata içerebilir.',
        ...
        expect(result).toBe(
            'Bu konu hakkında daha fazla bilgi veremem. Ancak yardımcı olabileceğim başka bir konu varsa yazabilirsiniz.\n\n> Bu mesaj AI bot tarafından oluşturuldu, hata içerebilir.'
        )
    })

    it('removes model-supplied Turkish disclaimer before appending the app-owned footer', () => {
        const result = applyBotMessageDisclaimer({
            message: "Prof. Dr. Şebnem KAVAKLI, 1977 yılında doğmuştur. > Bu mesaj AI bot tarafından oluşturuldu, hata içerebilir.",
            responseLanguage: 'tr',
            settings: {
                bot_disclaimer_enabled: true,
                bot_disclaimer_message_tr: 'Bu mesaj AI bot tarafından oluşturuldu, hata içerebilir.',
        ...
        expect(result).toBe(
            'Prof. Dr. Şebnem KAVAKLI, 1977 yılında doğmuştur.\n\n> Bu mesaj AI bot tarafından oluşturuldu, hata içerebilir.'
        )
    })

    it('removes model-supplied disclaimer even when the app disclaimer is disabled', () => {
        const result = applyBotMessageDisclaimer({
            message: 'Merhaba\n\n> Bu mesaj AI bot tarafından oluşturuldu, hata içerebilir.',
            responseLanguage: 'tr',
            settings: {
