...
function systemPrompt(responseLanguage: MvpResponseLanguage) {
    return [
        ...
        'Always inspect recent conversation history before rewriting. Use it only to resolve references, omitted facets, follow-up confirmations, and short corrections; do not copy the history into the query.',
