declare module 'iyzipay' {
    class Iyzipay {
        ...
        static SUBSCRIPTION_UPGRADE_PERIOD: { NOW: string; NEXT_PERIOD?: string; [key: string]: string }
        ...
        subscriptionCard: {
            updateWithSubscriptionReferenceCode: (request: unknown, cb: (error: unknown, result: unknown) => void) => void
        }

        subscriptionPayment: {
            retry: (request: unknown, cb: (error: unknown, result: unknown) => void) => void
        }
