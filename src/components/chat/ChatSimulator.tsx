...
import { Send, Bug, MessageSquare, Sparkles } from 'lucide-react'
...
export default function ChatSimulator({
  ...
  const tIntro = useTranslations('simulator.introModal')
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    const history: ConversationTurn[] = messages.slice(-8).map((msg) => ({
  ...
  return (
    <>
      <WorkspaceIntroModal
        ...
        secondaryHref="/settings/ai"
        items={[
          {
            id: 'real-message',
            icon: <MessageSquare size={18} />,
            title: tIntro('items.realMessage.title'),
            body: tIntro('items.realMessage.body'),
          },
          {
            id: 'see-ai-reply',
            icon: <Sparkles size={18} />,
            title: tIntro('items.seeAiReply.title'),
            body: tIntro('items.seeAiReply.body'),
          },
          {
            id: 'debug-desktop',
            icon: <Bug size={18} />,
            title: tIntro('items.debugDesktop.title'),
            body: tIntro('items.debugDesktop.body'),
          },
        ]}
      />
          ...
          {debugInfo ? (
            <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
              ...
              <div className="p-4 rounded-lg bg-blue-50 border border-blue-100">
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="text-gray-700 font-mono text-sm font-medium">
                    {(debugInfo.similarity * 100).toFixed(1)}%
                  </span>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-gray-50 border border-gray-100">
                ...
                <p className="text-gray-500 text-xs font-mono mt-1 break-all bg-white p-1 rounded border border-gray-100">
                  {debugInfo.id}
                </p>
              </div>
            </div>
