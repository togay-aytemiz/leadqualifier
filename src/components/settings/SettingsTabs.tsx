...
export function SettingsTabs({
  ...
  const [internalActiveTabId, setInternalActiveTabId] = useState(() =>
    resolveInitialTabId(tabs, activeTabId, defaultTabId)
  )
  const controlledActiveTabId =
  ...
  const resolvedActiveTabId =
    ...
    (tabs.some((tab) => tab.id === internalActiveTabId) ? internalActiveTabId : fallbackTabId)
