-- Consume persistent extra credits before the monthly package for premium usage.
-- This keeps carried-over trial credits from being stranded behind a fresh package.
