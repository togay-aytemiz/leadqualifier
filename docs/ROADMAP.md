...
> **Last Updated:** 2026-06-12 (YİÜ Public Demo non-Skill replies now use the simplified LLM planner -> OpenAI File Search -> evidence validation -> polish pipeline; Skills remain unchanged.)
