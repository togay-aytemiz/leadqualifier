...
> **Last Updated:** 2026-04-30 (App entry now skips the root onboarding redirect read, and dashboard root loading uses a localized branded Qualy progress surface while deeper dashboard shell/RPC latency work remains queued.)
