...
> **Last Updated:** 2026-04-24 (`Settings > Usage` credit history now has movement filters, simplified record/aggregate tables, labeled inline filter controls, complete-period aggregate lazy loading, and lazy-loaded all-time history; customer-facing webhook runtimes still fail closed to `Kapalı` when AI settings cannot be loaded.)
