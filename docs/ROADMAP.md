...
- [x] **Navigation Shell**
  ...
  - [x] Manual navigation prefetch warmups now run only in production; development mode skips these warmups to avoid continuous Next.js `Compiling...` churn while navigating
