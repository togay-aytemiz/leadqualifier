...
> **Last Updated:** 2026-06-12 (Production UI smoke now covers a systematic 100-question selection from the 508-question set, and YİÜ Public Demo non-Skill replies now use the simplified LLM planner -> metadata-scoped multi-query OpenAI File Search with one expanded evidence retry -> evidence/table validation -> polish pipeline while Skills remain unchanged.)
