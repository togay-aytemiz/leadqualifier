...
> **Last Updated:** 2026-05-25 (Yüksek İhtisas demo RAG now has general evidence-first retrieval, answer repair, PDF type backfill, source-link cleanup, timeout extractive recovery, and 33/33 live screenshot-plus-variant QA coverage for PDF/crawl-backed answers.)
