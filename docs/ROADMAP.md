...
> **Last Updated:** 2026-05-29 (Public Demo Chat fast RAG now short-circuits deterministic source-backed repairs before settings/generation/polish, medicine training/staj repair compacts dense regulation evidence without changing grounded facts, generated answers still run through deterministic repair before source-linking, repaired generated answers can receive bounded organization-voice polish, broad duration policies preserve grouped source brackets, contact repair/source links avoid generic/footer-phone program conflation, engagement tails are stripped unless they are source-grounded adjacent-detail offers, contextual follow-ups filter candidate chunks to the latest explicit topic anchor, shared-predicate compound questions expand into per-subject retrieval queries, and campus repair completes omitted requested subjects from evidence.)
