...
> **Last Updated:** 2026-05-28 (RAG now better handles ASCII Turkish university/policy questions, keeps contact-number intent separate from document-code repair, strips English retrieval boilerplate from Turkish grounded answers, repairs referential final/bütünleme evidence more generally, and prevents UI document codes from becoming fake clickable domains.)
