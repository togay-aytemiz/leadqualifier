...
> **Last Updated:** 2026-05-28 (RAG now prefers conversation-aware retrieval and source-quote-validated grounded generation before deterministic repair, refuses deterministic repair for contextual follow-ups that cannot be verified, then can apply bounded source-grounded polish for organization voice/engagement; demo polling budgets are capped below platform timeout and source URL lines stay standalone after contact/e-mail answers.)
