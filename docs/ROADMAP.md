...
> **Last Updated:** 2026-05-28 (RAG now prefers the real conversation-aware inbound pipeline and source-quote-validated grounded generation before deterministic repair, while still preserving ASCII Turkish intent/language repair, contact-number/document-code separation, Turkish boilerplate cleanup, referential final/bütünleme repair, and document-code-safe UI autolinking.)
