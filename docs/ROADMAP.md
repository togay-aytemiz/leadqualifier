...
> **Last Updated:** 2026-05-21 (Knowledge Base indexing preserves structural section boundaries, policy-duration retrieval can answer from grounded evidence before vector search, and large-corpus vector search now has a bounded fallback path to avoid API timeouts.)
