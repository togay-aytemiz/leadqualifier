...
- [x] **Instagram (Meta Messaging)**
  ...
  - [x] Instagram connect now merges Instagram Login profile data with real page discovery when available so stored `page_id` matches Meta webhook delivery identity instead of collapsing to the Instagram business account id
