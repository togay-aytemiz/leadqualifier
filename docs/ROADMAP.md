...
> **Last Updated:** 2026-06-13 (Replaced the expired YİÜ store with a persistent 135-file OpenAI vector store, restored organization-aware standalone rewrites, increased retrieval to 20 results, moved grounded answers to `gpt-4.1-mini`, and separated operational source failures from factual no-info.)
