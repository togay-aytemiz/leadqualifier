...
- [ ] Add an explicit clarification decision/response contract; the current one-step schema supports only `answer | no_info | refuse` and does not consume the query rewriter's `needsClarification` decision.
...
> **Last Updated:** 2026-06-20 (Added the zero-overlap 100 and realistic clarification harness; marked the quota-exhausted production run invalid and recorded the missing clarification contract.)
