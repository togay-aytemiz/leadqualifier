...
- [ ] Tighten Skill verifier broad-subject coverage so one-program Skills cannot answer all-program ranking/campus/fact questions.
...
> **Last Updated:** 2026-06-19 (Reopened the YİÜ production demo, reran same-seed random 100, and logged remaining Skill/RAG quality root causes.)
