...
- [x] **Channel-Aware Text Formatting:** Normalize outgoing bot text for WhatsApp, Instagram, and Telegram by preserving raw URLs, repairing spaced Markdown/raw URL artifacts, cleaning unsupported Markdown, and converting inline dash-separated RAG lists into readable message bullets before send/persist
