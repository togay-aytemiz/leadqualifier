...
- [ ] **Paywall Implementation (Execution)**
  ...
  - [x] Clarify active premium Iyzico confirmation popups so direct plan changes show current vs target monthly price, effect timing, and a provider-calculated-charge notice instead of promising a hosted payment screen or exact upgrade amount
