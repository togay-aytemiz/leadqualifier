...
> **Last Updated:** 2026-06-08 (The isolated YİÜ Tanıtım Test organization, `yiu-tanitim-gunleri-2026` demo channel, approved corpus, preview-only validated OpenAI File Search bridge, strict quality mode, global evaluator/retry, research-plan/tool-router diagnostics, claim-ledger verification, facet-aware answer contract, evidence-seeking retry, actionable no-info boundaries, and deterministic catalog layers remain configured. The latest quality pass adds strict direct-answer diagnostics, source-of-truth score reporting, auto catalog-candidate generation, strictQuality-first scoring, and generic decision-safe boundaries for preference advice, academic process, subjective reputation, housing/local-life, and inflected facility-resource prompts. A broad grounded-direct rerun retested `155` candidates and improved `125`; the final current-7 closure rerun moved all `15/15` remaining `7` answers to `8/10`. The full 508-question artifact-merged distribution is now `0` x `7`, `346` x `8`, `159` x `9`, and `3` x `10`, with `0` questions below `8`. The largest remaining approved-source worklists are clinical/staj/lab, campus/housing/transport, admissions-decision, finance/payment, credential/recognition, professional-outcome, and contact/next-step facts. The existing `yiu-qualy-ai-demo` and global Supabase RAG default remain unchanged.)
