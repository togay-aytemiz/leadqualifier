...
> **Last Updated:** 2026-05-29 (Public Demo Chat contextual follow-ups try context-expanded focused evidence before broad search, persisted demo bot replies include `rag_diagnostics` timing/search-strategy metadata for latency triage, deterministic fast-path answers may receive source-title-supported micro-polish, source-backed repairs short-circuit settings/generation/polish work, generated answers still run through deterministic repair before source-linking, broad duration policies preserve grouped source brackets, contact repair/source links avoid generic/footer-phone program conflation, engagement tails are stripped unless they are source-grounded adjacent-detail offers, contextual follow-ups filter candidate chunks to the latest explicit topic anchor, shared-predicate compound questions expand into per-subject retrieval queries, and campus repair completes omitted requested subjects from evidence.)
