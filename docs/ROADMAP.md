...
- [x] **Inbox UI**
  ...
  - [x] Conversation list row-level human-attention indicator is compact red `!` (tooltip keeps reason detail: `Skill handover` / `Hot lead`)
