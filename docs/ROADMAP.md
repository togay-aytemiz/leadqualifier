...
> **Last Updated:** 2026-05-20 (University demo chat added a first-party `app.askqualy.com` public URL, server-side demo slug mapping, isolated tester sessions, Inbox persistence, and read-only operator handling for the new `demo_chat` channel.)
