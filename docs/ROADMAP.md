...
> **Update Note (2026-06-02):** Shared inbound replies now evaluate Skills before scheduling, required-intake loading, RAG routing, fallback generation, or other token-consuming work. Exact/generic Skill turns such as greetings can respond quickly, while messages without a Skill match continue through scheduling and Knowledge Base recovery. ASCII-written Turkish help/scope messages are also classified as Turkish so Turkish user turns do not drift into English replies.
