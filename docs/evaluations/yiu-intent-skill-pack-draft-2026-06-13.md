# YİÜ Intent Skill Pack Draft

Durum: Onay sonrası DB'ye push edildi. Kaynak doküman ve yeniden çalıştırılabilir seed/push referansı olarak tutuluyor.
Hazırlanma tarihi: 2026-06-13
Hedef: Yüksek İhtisas Üniversitesi demo botu için RAG öncesinde veya RAG ile birlikte çalışabilecek intent/yetenek paket taslağı.
...
- Skill title prefix: `YİÜ Intent - `
- Push sonucu: 60 skill inserted, 0 updated, 0 unchanged
- Embedding sonucu: 360 `skill_embeddings` satırı yenilendi
- Not: Script idempotent çalışır; aynı başlıklı `YİÜ Intent - ...` skill varsa update eder, yoksa insert eder.
...
## 12. tip_fakultesi_var_mi

Amaç: Üniversitede Tıp Fakültesi olup olmadığını direkt cevaplamak.

Kullanıcı örnekleri:
- Üniversitenizde Tıp Fakültesi var mı?
- Tıp bölümü var mı?
- YİÜ'de tıp okuyabilir miyim?
- Tıp programınız var mı?
- Tıp fakülteniz bulunuyor mu?

Instructed cevap:
Evet, Yüksek İhtisas Üniversitesinde Tıp Fakültesi bulunmaktadır. Tıp Fakültesi, üniversitenin lisans düzeyindeki akademik birimlerinden biridir.

Tıp Fakültesiyle ilgili eğitim dili, ücret, kontenjan, burs, yerleşke ve eğitim modeli hakkında bilgi almak istersen yardımcı olabilirim.

Kaynak notu: Ana web sitesi akademik menüsü, tanıtım broşürü.

---

## 13. tip_fakultesi_egitim_dili

Amaç: Türkçe/İngilizce Tıp programlarını açıklamak.
...
Instructed cevap:
Tanıtım broşüründe Tıp Fakültesi için Türkçe ve İngilizce program bilgisi yer almaktadır. Tıp Fakültesi (Türkçe) ve Tıp Fakültesi (İngilizce) ayrı program satırlarıyla listelenmiştir.

Programların güncel öğretim dili, kontenjanı, burs türü ve özel koşulları her tercih döneminde ÖSYM kılavuzu ve üniversitenin güncel aday öğrenci duyuruları ile kesinleşir. Tercih yapmadan önce ilgili yılın ÖSYM kılavuzunda program adını ve özel koşulları mutlaka kontrol etmeni öneririm.

Kaynak notu: Tanıtım broşürü Tıp Fakültesi tablosu.
...
Amaç: Türkçe Tıp ücret sorularını direkt tablo satırıyla cevaplamak.

Kullanıcı örnekleri:
- Tıp ücreti ne kadar?
- Türkçe Tıp kaç TL?
- Tıp Fakültesi ücretli fiyatı nedir?
- Tıp %50 indirimli kaç para?
- Tıp burslu ücret öder mi?

Instructed cevap:
2025 tanıtım broşüründeki Tıp Fakültesi Türkçe program satırlarına göre:

- Tıp Fakültesi (Ücretli): 720.000 TL
- Tıp Fakültesi (%50 İndirimli): 360.000 TL
- Tıp Fakültesi (Burslu): ücret alanı `-` olarak gösterilmiş

Bu bilgiler broşür bilgisidir. Kesin kayıt ve ödeme koşulları için ilgili yılın ÖSYM kılavuzu ve üniversitenin güncel ücret duyuruları kontrol edilmelidir.

Kaynak notu: Tanıtım broşürü Tıp Fakültesi 2025 kontenjan ve fiyat tablosu.

---

## 21. tip_ucret_ingilizce

Amaç: İngilizce Tıp ücret sorularını direkt tablo satırıyla cevaplamak.

Kullanıcı örnekleri:
- İngilizce Tıp ücreti ne kadar?
- Tıp İngilizce kaç para?
- İngilizce Tıp %50 indirimli fiyatı nedir?
- Tıp İngilizce burslu ücretli mi?
- İngilizce Tıp ücretli 2025 fiyatı nedir?

Instructed cevap:
2025 tanıtım broşüründeki İngilizce Tıp satırlarına göre:
...
Ayrıca broşürde Tıp Fakültesi hazırlık satırı için 410.000 TL bilgisi yer alır. Hazırlığın hangi öğrenci için zorunlu olduğu ve güncel özel koşullar ÖSYM kılavuzu ile doğrulanmalıdır.

Kaynak notu: Tanıtım broşürü Tıp Fakültesi 2025 kontenjan ve fiyat tablosu.

---

## 22. tip_kontenjan_turkce

Amaç: Türkçe Tıp kontenjan sorularını cevaplamak.
...
- Tıp %50 indirimli kontenjanı nedir?

Instructed cevap:
2025 tanıtım broşüründeki Türkçe Tıp satırlarına göre kontenjanlar şöyle:

- Tıp Fakültesi (Ücretli): 75
- Tıp Fakültesi (Burslu): 13
- Tıp Fakültesi (%50 İndirimli): 10

Kontenjanlar tercih döneminde ÖSYM kılavuzu ile kesinleştiği için son kontrolü ilgili yılın ÖSYM kılavuzundan yapmak gerekir.

Kaynak notu: Tanıtım broşürü Tıp Fakültesi 2025 kontenjan ve fiyat tablosu.

---

## 23. tip_kontenjan_ingilizce

Amaç: İngilizce Tıp kontenjan sorularını cevaplamak.

Kullanıcı örnekleri:
- İngilizce Tıp kontenjanı kaç?
- Tıp İngilizce kaç kişi alıyor?
- İngilizce Tıp ücretli kontenjan kaç?
- İngilizce Tıp burslu kaç kişilik?
- İngilizce Tıp %50 indirimli kontenjanı nedir?

Instructed cevap:
2025 tanıtım broşüründeki İngilizce Tıp satırlarına göre kontenjanlar şöyle:

- Tıp Fakültesi (İngilizce) (Ücretli): 41
- Tıp Fakültesi (İngilizce) (Burslu): 7
- Tıp Fakültesi (İngilizce) (%50 İndirimli): 6

Kontenjanlar için son ve bağlayıcı kaynak ilgili yılın ÖSYM kılavuzudur.
...
Amaç: Tıp taban puanı sorularında Türkçe/İngilizce ve burs türünü ayırarak cevaplamak.

Kullanıcı örnekleri:
- Tıp taban puanı kaç?
- İngilizce Tıp taban puanı nedir?
- Tıp burslu taban puanı kaç?
- Tıp ücretli kaç puanla almış?
- Tıp %50 indirimli taban puanı nedir?

Instructed cevap:
Broşürde 2024 taban puanları referans olarak verilmiş. Tıp Fakültesi satırları şöyle:

- Tıp Fakültesi (Ücretli): 453,467
- Tıp Fakültesi (Burslu): 497,406
- Tıp Fakültesi (%50 İndirimli): 483,077
- Tıp Fakültesi (İngilizce) (Ücretli): 448,213
- Tıp Fakültesi (İngilizce) (Burslu): 496,513
- Tıp Fakültesi (İngilizce) (%50 İndirimli): 479,259

Bu değerler geçmiş yıl referansıdır; tercih yaparken güncel ÖSYM verileriyle değerlendirilmelidir.

Kaynak notu: Tanıtım broşürü Tıp Fakültesi 2024 taban puanı sütunu.

---

## 25. tip_basari_sirasi

Amaç: Tıp başarı sırası sorularını Türkçe/İngilizce ve burs türüne göre cevaplamak.

Kullanıcı örnekleri:
- Tıp başarı sırası kaç?
- İngilizce Tıp sıralaması nedir?
- Tıp burslu kaç binle almış?
- Tıp ücretli sıralama kaç?
- Tıp %50 indirimli başarı sırası nedir?

Instructed cevap:
Broşürde 2024 başarı sıraları referans olarak verilmiş. Tıp Fakültesi satırları şöyle:

- Tıp Fakültesi (Ücretli): 36.073
- Tıp Fakültesi (Burslu): 11.519
- Tıp Fakültesi (%50 İndirimli): 18.145
- Tıp Fakültesi (İngilizce) (Ücretli): 39.907
- Tıp Fakültesi (İngilizce) (Burslu): 11.890
- Tıp Fakültesi (İngilizce) (%50 İndirimli): 20.117

Başarı sıraları geçmiş yıl referansıdır; yerleşme garantisi vermez.

Kaynak notu: Tanıtım broşürü Tıp Fakültesi 2024 başarı sırası sütunu.
...
## 49. diger_burs_indirimler

Amaç: Şehit-gazi, kardeş, spor ve sosyal destek burslarını özetlemek.

Kullanıcı örnekleri:
- Kardeş indirimi var mı?
- Şehit gazi çocuğu bursu var mı?
- Sporcu bursu veriyor musunuz?
- Sosyal destek bursu var mı?
- Başka hangi burslar var?

Instructed cevap:
Broşürde YKS üstün başarı, tercih ve akademik başarı bursu dışında şu burs/indirim başlıkları da yer alıyor:

- Şehit ve Gazi Çocukları Bursu: eğitim öğretim ücretine %25 indirim.
- Kardeş Bursu: üniversitede öğrenim gören kardeş öğrencilerin her biri için eğitim öğretim ücreti üzerinden %5 indirim.
- Spor Başarı Bursu: milli sporcular için, her yıl Mütevelli Heyet tarafından belirlenen burs.
- Sosyal Destek Bursu: maddi güçlük yaşayan öğrenciler için nakit, kitap, kırtasiye, beslenme, barınma gibi destek türleri; miktar her yıl Mütevelli Heyet tarafından belirlenir.

Güncel koşullar ve başvuru belgeleri için resmi duyurular kontrol edilmelidir.
...
## 51. tip_sinif_gecme_not_hesabi

Amaç: Tıp Fakültesi sınıf geçme ve not hesaplama sorularını cevaplamak.

Kullanıcı örnekleri:
- Tıp Fakültesinde sınıf geçme notu nasıl hesaplanıyor?
- Dönem sonu başarı notu nasıl bulunur?
- Tıpta kurul notu nasıl hesaplanır?
- Tıp sınıf geçmek için kaç almak lazım?
- Final ve kurul oranları nedir?
...
Dönem içi kurul notunda ders kurulu sınavları ağırlıklıdır; Hekimliğe Uyum Kurulu ve Kanıta Dayalı Tıp Kurulu notları varsa ayrıca küçük oranlarla hesaba katılır. Başarılı sayılmak için dönem sonu başarı notunun en az 60 olması gerektiği belirtilir.

Bu kurallar yönerge maddelerine bağlı olduğu için öğrencinin kendi dönemi ve güncel yönerge metni ayrıca kontrol edilmelidir.

Kaynak notu: Tıp Fakültesi Eğitim-Öğretim ve Sınav Yönergesi, Ölçme-Değerlendirme yönergeleri.

---

## 52. tip_finale_girmeden_gecme

Amaç: Final sınavına girmeden geçme sorularını cevaplamak.

Kullanıcı örnekleri:
- Tıpta finale girmeden geçebilir miyim?
- Final sınavına girmeden sınıf geçmek mümkün mü?
- Kurul ortalamam yüksekse finale girmem gerekir mi?
- Tıp final muafiyeti var mı?
- Hangi şartlarda finalden muaf olurum?

Instructed cevap:
Tıp Fakültesi yönerge çıktılarında Dönem I, II ve III için dönem içi kurul notu yüksek olan öğrencilerin bazı koşullarla dönem sonu final sınavına girmeksizin başarılı sayılabileceği bilgi olarak yer alıyor. Öne çıkan şartlar: dönem içi kurul notunun en az 80 olması ve ilgili dönemde ders kurulu sınav notlarının her birinin en az 60 olmasıdır.

Bu konu öğrencinin dönemine ve güncel yönerge metnine bağlıdır. Bu yüzden karar vermeden önce güncel Tıp Fakültesi Eğitim-Öğretim ve Sınav Yönergesi ile öğrenci işleri/fakülte duyurusunu kontrol etmek gerekir.

Kaynak notu: Tıp Fakültesi Eğitim-Öğretim ve Sınav Yönergesi değerlendirme çıktıları.

---

## 53. tip_butunleme_sinavi

Amaç: Tıp Fakültesi bütünleme sınavı sorularını cevaplamak.

Kullanıcı örnekleri:
- Tıpta bütünlemeye girebilir miyim?
- Finale girmezsem bütünlemeye kalır mıyım?
- Final notum düşükse ne olur?
- Bütünleme final yerine geçer mi?
- Tıp Fakültesinde bütünleme hakkı var mı?

Instructed cevap:
Tıp Fakültesi yönerge kaynaklarında final sınavına girmesi gerektiği halde girmeyen veya final sınav puanı yeterli olmayan öğrencilerin bütünleme sınavına girebileceği; bütünleme notunun final notu yerine geçtiği bilgisi yer alır.

Bu bilgi genel yönerge çerçevesidir. Hangi dönem/staj için hangi koşulların geçerli olduğu güncel akademik takvim ve fakülte duyurularıyla kontrol edilmelidir.
