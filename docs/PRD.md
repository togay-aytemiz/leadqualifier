...
> **Last Updated:** 2026-05-28 (RAG answer quality now includes context-anchored retrieval/generation, source-quote-validated grounded generation before deterministic repair, no deterministic repair for unverified contextual follow-ups, bounded source-grounded polish for generated and extractive answers, strict KB-quote validation for engagement follow-ups, capped demo polling waits, compound-question retrieval, abortable polish calls, and localized standalone source labels.)
