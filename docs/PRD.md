...
- Pending WhatsApp and Instagram setup surfaces should opportunistically refresh on browser `focus` / `visibilitychange` so verification state can update quickly after the operator returns from sending that test message.
