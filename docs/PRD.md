...
> **Last Updated:** 2026-05-21 (Demo Chat persists bot replies idempotently by source message id/kind, Knowledge Base ingestion preserves structural section boundaries, and large-corpus vector search now falls back before database statement timeouts can block replies.)
...
> Finalized: 2026-01-31 (updated with implementation decisions through 2026-05-21)
