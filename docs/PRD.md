...
- **System Admin Internal Org Exclusion:** Exclude internal QA tenant (`AI QA LAB` / `ai-qa-lab`) from system-admin organization picker lists and fallback active-org resolution so admin panel impersonation targets customer tenants only.
