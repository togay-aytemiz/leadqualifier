...
> **Last Updated:** 2026-05-28 (RAG answer quality now includes conversation-aware retrieval/generation, source-quote-validated grounded generation before deterministic repair, bounded source-grounded polish for generated and extractive answers, strict KB-quote validation for engagement follow-ups, factual-value preservation fallback, capped demo polling waits, compound-question retrieval, abortable polish calls, and localized standalone source labels.)
