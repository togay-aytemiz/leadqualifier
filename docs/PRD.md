...
> **Last Updated:** 2026-05-21 (Knowledge Base ingestion now preserves structural section boundaries and `Section:` metadata before embedding so exact clauses can be retrieved without adjacent-topic contamination.)
