...
> **Last Updated:** 2026-04-25 (Dashboard/Settings navigation now reuses server shell billing and AI data, gates hidden-shell prefetch work, avoids automatic nav `Link` prefetch, uses existence reads for sidebar pending badges, and shows immediate Settings detail-pane skeletons on cold transitions.)
