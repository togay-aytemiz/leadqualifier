...
> **Last Updated:** 2026-03-31 (`Settings > Channels` now requires the gallery order `WhatsApp`, `Instagram`, `Facebook Messenger`, `Telegram` and a maximum of 3 columns on wide desktop so the fourth card wraps onto a second row cleanly.)
