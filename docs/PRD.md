...
> **Last Updated:** 2026-05-21 (Knowledge Base ingestion preserves structural section boundaries, policy-duration retrieval can return grounded evidence before vector search, and large-corpus vector search now falls back before database statement timeouts can block replies.)
