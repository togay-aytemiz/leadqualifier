...
> **Last Updated:** 2026-04-29 (Runtime hardening now fails closed for billing entitlement/RPC access, Meta webhook signature ordering, AI grounding/matcher errors, and bounded AI request deadlines, alongside frontend accessibility/polish guards.)
