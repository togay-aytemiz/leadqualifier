...
> **Last Updated:** 2026-04-24 (`Settings > Usage` credit history now has current/previous/all-time filters, compact ledger labels, record plus daily/weekly/monthly aggregate views, and lazy-loaded pages; runtime AI-settings reads still fail closed for customer-facing webhook paths.)
