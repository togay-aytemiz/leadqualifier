...
> **Update Note (2026-05-21):** Public Demo Chat composers should use a mobile-friendly autosizing textarea instead of a fixed single-line input. Long questions should expand the composer up to a controlled height, support Enter-to-send plus Shift+Enter line breaks, keep internal scrolling available without showing a native scrollbar, keep the disclosure near the composer, and use only one bottom-right send button without attachment or instant-action dropdown affordances.
...
> **Last Updated:** 2026-05-21 (Public Demo Chat notice copy now points Qualy information requests to `www.askqualy.com`, and the mobile composer keeps autosizing textarea scrolling hidden.)
