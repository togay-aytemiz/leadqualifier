...
> **Last Updated:** 2026-05-28 (RAG answer quality now includes conversation-aware retrieval/generation, source-quote-validated grounded answer generation before deterministic repair, bounded source-grounded LLM polish fallback for extractive answers, strict KB-quote validation for engagement follow-ups, factual-value preservation fallback, compound-question retrieval, abortable polish calls, and localized demo source labels.)
