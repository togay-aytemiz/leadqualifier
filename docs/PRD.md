...
> **Last Updated:** 2026-03-31 (Collapsed desktop sidebar now requires a dark rail with white branding/icons and immediate nav-item hover tooltips in slim mode; `Settings > Channels` still requires the `WhatsApp`, `Instagram`, `Facebook Messenger`, `Telegram` order and a maximum of 3 columns on wide desktop.)
