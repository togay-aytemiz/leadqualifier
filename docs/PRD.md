...
> **Last Updated:** 2026-05-29 (Public Demo Chat fast RAG may return deterministic source-backed repairs without settings/generation/polish work, medicine training/staj repairs compact dense regulation evidence without losing grounded facts, grounded RAG generation remains quote-validated, generated replies also pass through deterministic intent repair before source-linking, repaired generated replies may use bounded organization-voice polish, grouped policy-duration evidence must remain grouped, focused contact answers and source links avoid generic/footer phone conflation, engagement tails are rejected unless specific, source-grounded adjacent-detail offers, contextual follow-ups filter candidate chunks to the latest explicit topic anchor, shared-predicate compound questions expand into per-subject retrieval queries, and campus answer repair completes omitted requested subjects when evidence exists.)
...
> Finalized: 2026-01-31 (updated with implementation decisions through 2026-05-27)
