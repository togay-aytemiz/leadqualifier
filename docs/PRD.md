...
> **Last Updated:** 2026-05-20 (University demo chat now uses a first-party `app.askqualy.com` slug mapped server-side to a demo organization, with per-tester session isolation, Inbox persistence, and operator replies disabled for `demo_chat`.)
...
> Finalized: 2026-01-31 (updated with implementation decisions through 2026-05-20)
