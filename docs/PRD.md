...
> **Last Updated:** 2026-05-22 (Public Demo Chat and Iyzico card-update callbacks require signed/provider tokens before service-role writes, redirect/media proxy inputs are bounded, WhatsApp webhook work is acknowledged before AI processing, billing renewal checks avoid repeated RPCs, and runtime dependency audit is clean.)
...
> Finalized: 2026-01-31 (updated with implementation decisions through 2026-05-22)
