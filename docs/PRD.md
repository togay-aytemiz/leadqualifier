...
> **Last Updated:** 2026-05-15 (Signup/login auth callback and resilient post-auth redirects.)
...
| Supabase Data API Grants | **Explicit authenticated/service-role grants with RLS** | Public schema table access should not depend on Supabase default grants; authenticated/service-role grants are explicit while anon table access remains closed except RPC signup guards. |
