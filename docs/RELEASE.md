...
- Changed package section hierarchy in `Settings > Plans` by removing the trailing disclaimer line and relying on the existing top assumption note for cleaner scanning (`src/app/[locale]/(dashboard)/settings/plans/page.tsx`).
